...
public class SnakeGame implements ActionListener, KeyListener {
	...
	private void randomizeFoodLocation() {
		...
		Location randLoc = new Location((int) (Math.random() * WIDTH), (int) (Math.random() * HEIGHT));
	...
	private void gameOver() {
		...
		int buttonSelected = JOptionPane.showConfirmDialog(null, "Freakin loser.Play Again?", "Game Over!",
